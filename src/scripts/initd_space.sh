...
# Description:       Start / Stop space Service
### END INIT INFO
...
DAEMON="/usr/bin/python3 /opt/space/src/main.py"
DAEMON_OPTS="--daemon"
RUN_USER="space"
RUN_GROUP="space"

MONITOR_ENABLEFILE="/etc/opt/space/monitor_enable"
MONITOR_PIDFILE="/run/${NAME}/monitor.pid"
MONITOR_DAEMON="/opt/space/src/scripts/monitorAlexa.sh"
